...
def unison_sorted_copies(a, b):
    ...
    p = a.argsort()
    return a[p], b[p]
r_arr, L_l=unison_sorted_copies(r_arr,L_l)
print(r_arr)
#print(tau)
A=trapz(L_l, r_arr)
print(A)
...
L_l=L_l/A
print(trapz(L_l, r_arr))


# In[10]:


mean=trapz(L_l*r_arr, r_arr)
print(mean)
...
var=trapz(L_l*(r_arr-mean)**2,r_arr)
print(var)
